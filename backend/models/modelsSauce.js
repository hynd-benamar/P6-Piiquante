...
const modelsSauceSchema = mongoose.Schema({
    ...
    heat: { type: Number, required: true },//nombre entre 1 et 10 décrivant lasauce
    ...
    usersLiked: { type: [String] },// tableau des identifiants des utilisateurs qui ont aimé (= disliked) la sauce
